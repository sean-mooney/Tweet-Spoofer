        ...
        <div className="tweet-form">
          <div className="tweet-header">
            ...
            <div className="tweet-user-identifiers">
              ...
              <div className="tweet-user-handle">@realDonaldTrump</div>
            </div>
          ...
          <div className="tweet-post-message">
          ...
          <div className="tweet-post-info">
            <div className="tweet-post-date">
              <div className="tweet-post-date-time">2:08 PM</div>
              <div className="tweet-post-date-separator">·</div>
              <div className="tweet-post-date-mdy">Mar 24, 2020</div>
              <div className="tweet-post-date-separator">·</div>
            </div>
            <div className="tweet-post-device">Twitter for iPhone</div>
          </div>
          <div className="tweet-stats-content">
            <div className="tweet-stats-retweets">
              <span className="bold-text">16.8k</span>
              Retweets
            </div>
            <div className="tweet-stats-likes">
              <span className="bold-text">78.5k</span>
              Likes
            </div>
          </div>
